...
public class Game {
    ...
    private List<SeaBattleHomework.Ship> shipsPlayer1 = new ArrayList<>();
    private List<SeaBattleHomework.Ship> shipsPlayer2 = new ArrayList<>();
    List<Board> boards ;
    ...
    public void addShipsToEmptyBoard(){
        ...
        for(int i = 0; i<2 ; i ++) {
            SeaBattleHomework.Ship one = board1.createShip(0);
        ...
        SeaBattleHomework.Player player1 = new SeaBattleHomework.Player(shipsPlayer1,boardPLayer2);
        SeaBattleHomework.Player player2 = new SeaBattleHomework.Player(shipsPlayer2,boardPLayer1);
        Boolean gameOn = true;
        SeaBattleHomework.Display display = new SeaBattleHomework.Display();
