...
public class Display {
    ...
    public void printExitMessage() {
        System.out.println("Поиграем в другой раз. Хорошего дня!");

    }
    public void gameRules() {
        System.out.println("Одновременно в игре могут участвовать только два человека.\n" +
                "У каждого игрока есть своё поле - квадрат 10х10 клеток.\n" +
                "Игроки по очереди расставляют свои корабли:\n" +
                "       a. 4 однопалубных корабля,\n" +
                "       b. 3 двухпалубных,\n" +
                "       c. 2 трехпалубных,\n" +
                "       d. 1 четырёхпалубный.\n" +
                "Корабли можно располагать только по горизонтали или по вертикали.\n" +
                "Тот, кто первым, уничтожит все корабли - победитель.\n" +
                "Удачи! :)");
    }
